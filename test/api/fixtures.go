...
// suite. It is the single source of truth shared by UniqueName (which produces
// names) and IsTestResourceName (which the pre-suite sweep uses to recognise
// leaked resources): change it here and both ends stay in agreement.
...
// IsTestResourceName reports whether name was generated by UniqueName, i.e. it
// belongs to the integration suite and is therefore safe to reclaim.

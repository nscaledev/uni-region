...
type ClientInterface interface {
	...
	// PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithBody request with any body
	PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithBody(ctx context.Context, organizationID OrganizationIDParameter, regionID RegionIDParameter, imageID ImageIDParameter, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithBody(ctx context.Context, organizationID OrganizationIDParameter, regionID RegionIDParameter, imageID ImageIDParameter, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataRequestWithBody(c.Server, organizationID, regionID, imageID, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataRequestWithBody generates requests for PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDData with any type of body
func NewPostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataRequestWithBody(server string, organizationID OrganizationIDParameter, regionID RegionIDParameter, imageID ImageIDParameter, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/organizations/%s/regions/%s/images/%s/data", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithBodyWithResponse request with any body
	PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithBodyWithResponse(ctx context.Context, organizationID OrganizationIDParameter, regionID RegionIDParameter, imageID ImageIDParameter, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse, error)
...
type PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *ImageResponse
	JSON401      *externalRef0.UnauthorizedResponse
...
// Status returns HTTPResponse.Status
func (r PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithBodyWithResponse request with arbitrary body returning *PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse
func (c *ClientWithResponses) PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithBodyWithResponse(ctx context.Context, organizationID OrganizationIDParameter, regionID RegionIDParameter, imageID ImageIDParameter, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse, error) {
	rsp, err := c.PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithBody(ctx, organizationID, regionID, imageID, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse(rsp)
}
...
// ParsePostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse parses an HTTP response from a PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataWithResponse call
func ParsePostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse(rsp *http.Response) (*PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostApiV1OrganizationsOrganizationIDRegionsRegionIDImagesImageIDDataResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}

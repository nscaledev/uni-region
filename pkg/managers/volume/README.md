...
reason/message without continued polling. The explicit deletion-transition
predicate still wakes a parked Volume so unconditional provider and allocation
cleanup can run with the finalizer intact.

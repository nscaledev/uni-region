...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerSSHSpec) DeepCopyInto(out *ServerSSHSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerSSHSpec.
func (in *ServerSSHSpec) DeepCopy() *ServerSSHSpec {
	if in == nil {
		return nil
	}
	out := new(ServerSSHSpec)
	in.DeepCopyInto(out)
	return out
}

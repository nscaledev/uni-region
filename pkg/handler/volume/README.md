...
Before persisting the CRD, creation allocates that capacity in whole GiB
against the Identity `volume` quota, matching the GiB contract of the
registered quota kind. The allocation ID is stored on the Volume; a

...
func RegionTypeKubernetes() *TypeConversion[regionv1.Provider, regionapi.RegionType] {
	return &TypeConversion[regionv1.Provider, regionapi.RegionType]{
		Source: regionv1.ProviderKubernetes,
		Target: regionapi.RegionTypeKubernetes,
	}
}

func RegionTypeOpenstack() *TypeConversion[regionv1.Provider, regionapi.RegionType] {
	return &TypeConversion[regionv1.Provider, regionapi.RegionType]{
...
func TestConvertRegionType(t *testing.T) {
	...
	type TestCase struct {
		Name string
		Data *TypeConversion[regionv1.Provider, regionapi.RegionType]
	}
...
func RegionNorway() *TypeConversion[*regionv1.Region, *regionapi.RegionRead] {
	regionType := RegionTypeOpenstack()

	return &TypeConversion[*regionv1.Region, *regionapi.RegionRead]{
...
func RegionUnitedKingdom() *TypeConversion[*regionv1.Region, *regionapi.RegionRead] {
	regionType := RegionTypeOpenstack()
...
func RegionSpain() *TypeConversion[*regionv1.Region, *regionapi.RegionRead] {
...
func TestConvertRegion(t *testing.T) {
	...
	type TestCase struct {
		Name string
		Data *TypeConversion[*regionv1.Region, *regionapi.RegionRead]
	}
...
func RegionDetailSpain(domainName, kubeconfig string) *TypeConversion[*T2[*regionv1.Region, *corev1.Secret], *regionapi.RegionDetailRead] {
	region := RegionSpain()
	...
	return &TypeConversion[*T2[*regionv1.Region, *corev1.Secret], *regionapi.RegionDetailRead]{
		Source: &T2[*regionv1.Region, *corev1.Secret]{
			A: region.Source,
			B: &corev1.Secret{
...
func TestConvertRegionDetail(t *testing.T) {
	...
	type TestCase struct {
		Name        string
		Data        *TypeConversion[*T2[*regionv1.Region, *corev1.Secret], *regionapi.RegionDetailRead]
		ExpectError bool
	}
...
func ExternalNetworkA() *TypeConversion[*types.ExternalNetwork, *regionapi.ExternalNetwork] {
	return &TypeConversion[*types.ExternalNetwork, *regionapi.ExternalNetwork]{
...
func ExternalNetworkB() *TypeConversion[*types.ExternalNetwork, *regionapi.ExternalNetwork] {
	return &TypeConversion[*types.ExternalNetwork, *regionapi.ExternalNetwork]{
		Source: &types.ExternalNetwork{
...
func ExternalNetworkC() *TypeConversion[*types.ExternalNetwork, *regionapi.ExternalNetwork] {
	return &TypeConversion[*types.ExternalNetwork, *regionapi.ExternalNetwork]{
		Source: &types.ExternalNetwork{
...
func TestConvertExternalNetwork(t *testing.T) {
	...
	type TestCase struct {
		Name string
		Data *TypeConversion[*types.ExternalNetwork, *regionapi.ExternalNetwork]
	}

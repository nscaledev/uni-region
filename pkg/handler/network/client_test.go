...
func TestReferences(t *testing.T) {
	...
	client := network.New(cli, namespace, nil)

	// Create succeeds.
	require.NoError(t, client.ReferenceCreate(t.Context(), organizationID, projectID, networkID, reference))
	...
	// Delete succeeds.
	require.NoError(t, client.ReferenceDelete(t.Context(), organizationID, projectID, networkID, reference))

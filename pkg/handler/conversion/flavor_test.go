...
func TestConvertFlavor(t *testing.T) {
	...
	t.Run("cpu-only flavor", func(t *testing.T) {
		...
		require.Nil(t, out.Spec.InfiniBand)
	...
	t.Run("InfiniBand flavor populates infiniBand spec", func(t *testing.T) {
		t.Parallel()
		...
		require.NotNil(t, out.Spec.InfiniBand)
		require.Equal(t, 8, out.Spec.InfiniBand.PortCount)
	})

...
func (m *MockServerInterface) RebuildServer(ctx context.Context, id string, imageID ids.ImageID) (*servers.Server, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RebuildServer", ctx, id, imageID)
	ret0, _ := ret[0].(*servers.Server)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServerInterfaceMockRecorder) RebuildServer(ctx, id, imageID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RebuildServer", reflect.TypeOf((*MockServerInterface)(nil).RebuildServer), ctx, id, imageID)
}
...
// RebuildServer mocks base method.
func (m *MockComputeInterface) RebuildServer(ctx context.Context, id string, imageID ids.ImageID) (*servers.Server, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RebuildServer", ctx, id, imageID)
	ret0, _ := ret[0].(*servers.Server)
	ret1, _ := ret[1].(error)
...
// RebuildServer indicates an expected call of RebuildServer.
func (mr *MockComputeInterfaceMockRecorder) RebuildServer(ctx, id, imageID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RebuildServer", reflect.TypeOf((*MockComputeInterface)(nil).RebuildServer), ctx, id, imageID)
}

...
func (c *ComputeClient) DeleteKeypair(ctx context.Context, name string) error {
	_, span := traceStart(ctx, "DELETE /compute/v2/os-keypairs/{id}")
	defer span.End()

	span.SetAttributes(attribute.String("key_pair.id", name))
...
func (c *ComputeClient) DeleteServerGroup(ctx context.Context, id string) error {
	_, span := traceStart(ctx, "DELETE /compute/v2/os-server-groups/{id}")
	defer span.End()

	span.SetAttributes(attribute.String("server_group.id", id))
...
func (c *ComputeClient) DeleteServer(ctx context.Context, id string) error {
	_, span := traceStart(ctx, "DELETE /compute/v2/servers/{id}")
	defer span.End()

	span.SetAttributes(attribute.String("server.id", id))
...
func (c *ComputeClient) RebootServer(ctx context.Context, id string, hard bool) error {
	...
	_, span := traceStart(ctx, "POST /compute/v2/servers/{id}/action")
	defer span.End()

	span.SetAttributes(
		attribute.String("server.id", id),
		attribute.String("server.action", "reboot"),
		attribute.String("reboot.method", strings.ToLower(string(rebootMethod))),
	)
...
func (c *ComputeClient) StartServer(ctx context.Context, id string) error {
	...
	span.SetAttributes(
		attribute.String("server.id", id),
		attribute.String("server.action", "start"),
	)
...
func (c *ComputeClient) StopServer(ctx context.Context, id string) error {
	...
	span.SetAttributes(
		attribute.String("server.id", id),
		attribute.String("server.action", "stop"),
	)
...
func (c *ComputeClient) CreateRemoteConsole(ctx context.Context, id string) (*remoteconsoles.RemoteConsole, error) {
	_, span := traceStart(ctx, "POST /compute/v2/servers/{id}/remote-consoles")
	defer span.End()
...
func (c *ComputeClient) ShowConsoleOutput(ctx context.Context, id string, length *int) (string, error) {
	_, span := traceStart(ctx, "GET /compute/v2/servers/{id}/console-output")
	defer span.End()

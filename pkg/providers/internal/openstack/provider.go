...
func storageRange(prefix net.IPNet, reservations *unikornv1.NetworkReservations) *unikornv1.AttachmentIPRange {
	...
	if reservations != nil && reservations.VIPPoolPrefixLength != nil {
		// Users can explicitly opt out of storage.
		if *reservations.VIPPoolPrefixLength == reservations.PrefixLength {
			return nil
		}

		dotStart = 1 << (32 - *reservations.VIPPoolPrefixLength)
	}
